        ...
        <div className="flex items-center justify-between p-4 border-b border-surfaceBorder bg-surface/80 backdrop-blur-md z-10">
            ...
            <div className="flex items-center gap-4">
                <div className="flex items-center gap-2">
                    ...
                    <h3 className="font-bold text-gray-200">Interactive Dependency Graph [cite: 4]</h3>
                </div>
                {/* Button to restore original zoom and translation coordinates [cite: 5] */}
                <button 
                    onClick={resetView} 
            ...
            {/* Viewport Controls and Navigation Guide [cite: 6] */}
            <div className="flex items-center gap-3">
                {/* Visual Legend: Instructs the user on how to interact with the Canvas [cite: 7] */}
                ...
                {/* Fullscreen Toggle: Expands the graph to fill the entire browser window [cite: 8] */}
                <button 
                    onClick={() => setIsFullscreen(!isFullscreen)} 
                    className="p-2 hover:bg-surfaceBorder/50 rounded-lg text-gray-300 border border-surfaceBorder"
                >
                    {/* Dynamically switches icon based on the current window state [cite: 9] */}
